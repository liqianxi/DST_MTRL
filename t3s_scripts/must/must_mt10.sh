...
wandb disabled
python starter/mt_must_sac.py --config meta_config/must_configs/mt10/testing_must_mtsac.json --worker_nums 10 --eval_worker_nums 10 --seed $1 --pruning_ratio 0.4 --success_traj_update_only 1 --mask_end_update_episode 10 --use_trajectory_info 0
