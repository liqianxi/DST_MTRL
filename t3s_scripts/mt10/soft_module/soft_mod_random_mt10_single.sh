#!/bin/bash
#SBATCH --job-name=randomgoal_MT10SM
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
export NAME="10runs_randomgoal_MT10SM_exp1_seed${1}"
export TASK_SAMPLE_NUM=10

python starter/mt_para_mtsac_modular_gated_cas.py --config meta_config/mt10/modular_2_2_2_256_reweight_rand.json --seed $1 --worker_nums 10 --eval_worker_nums 10
duration=$SECONDS
